...
gconftool-2 --type as --set /org/gnome/desktop/wm/preferences ["Default","Second","Cool","Beans"]
...
gconftool-2 --type string --set /org/gnome/desktop/background/picture-uri "https://wpl.lib.in.us/logos/WPL_Logo_2016/WPL%20Logo%20Web%20Version/WPL_logo_web_700px.png"
